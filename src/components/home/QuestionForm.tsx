  ...
  return (
    <form className="question-form" onSubmit={handleSubmit}>
      ...
      <div className="question-input-wrap">
        <textarea id="question" value={question} onChange={(event) => setQuestion(event.target.value)} placeholder={medicalMode ? "What health question is on your mind?" : "What can we help you with?"} rows={2} />
