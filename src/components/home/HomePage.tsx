...
export function HomePage({ site }: { site: SiteConfig }) {
  return <>
    ...
    </div><div className="col-lg-5"><div className="hero-art"><img className="hero-photo" src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=900&q=85" alt="People having a thoughtful conversation" /><img className="hero-gif" src="https://media.giphy.com/media/26BRuo6sLetdllPAQ/giphy.gif" alt="" aria-hidden="true" /><div className="art-orbit orbit-one" /><div className="art-orbit orbit-two" /><div className="art-note note-main"><i className="bi bi-chat-heart" /><strong>Helpful context</strong><span>Useful information and a few clear starting ideas.</span></div><div className="art-note note-small"><i className="bi bi-check2" /> Easy to start</div><div className="art-grid" /></div></div></div></div></section>
