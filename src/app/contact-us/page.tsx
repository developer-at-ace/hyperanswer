              ...
              <div className="col-lg-5">
                ...
                <div className="contact-details">
                  <a href="mailto:support@trimmedi.com">
                    ...
                    <span>
                      <strong>Email</strong>support@trimmedi.com
                    </span>
                  </a>
                  <div>
                    <i className="bi bi-geo-alt" />
                    <span>
                      <strong>Mailing address</strong>95 N Moorland Rd,
              ...
              <div className="col-lg-6 ms-auto">
                <div className="contact-panel">
                  ...
                  <a
                    ...
                    href="mailto:support@trimmedi.com?subject=Trimmedi%20support%20request"
                  >
